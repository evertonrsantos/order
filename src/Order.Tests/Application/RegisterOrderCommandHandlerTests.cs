...
namespace Order.Tests.Application
{
    public class RegisterOrderCommandHandlerTests
    {
        ...
        public async Task Handle_WithValidCommand_ShouldCreateAndProcessOrder()
        {
            ...
            _orderRepositoryMock.Verify(r => r.AddAsync(It.IsAny<Domain.Entities.Order>(), It.IsAny<CancellationToken>()), Times.Once);
            _orderRepositoryMock.Verify(r => r.UpdateAsync(It.IsAny<Domain.Entities.Order>(), It.IsAny<CancellationToken>()), Times.Once);
        ...
        public async Task Handle_WithDuplicateExternalId_ShouldReturnFailureResponse()
        {
            ...
            var existingOrder = new Domain.Entities.Order("EXT-123", new List<Product>
            {
            ...
            _orderRepositoryMock.Verify(r => r.AddAsync(It.IsAny<Domain.Entities.Order>(), It.IsAny<CancellationToken>()), Times.Never);
        ...
        public async Task Handle_WithException_ShouldRollbackAndReturnFailureResponse()
        {
            ...
            _orderRepositoryMock.Setup(r => r.AddAsync(It.IsAny<Domain.Entities.Order>(), It.IsAny<CancellationToken>()))
